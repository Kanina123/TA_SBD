...
<div class="card mt-4">
	<div class="card-body">
		...
		<form method="post" action="<?php echo e(route('admin.store2')); ?>">
			<?php echo csrf_field(); ?>
            <div class="mb-3">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Laravel\applications\ta_sbd_nina\resources\views/admin/add2.blade.php ENDPATH**/ ?>